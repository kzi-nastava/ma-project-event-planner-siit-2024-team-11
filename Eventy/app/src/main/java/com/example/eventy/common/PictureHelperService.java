...
public class PictureHelperService {
    ...
    public static Drawable getPicture(String base64Image, Context context) {
        if (base64Image == null || base64Image.isEmpty()) {
            base64Image = defaultProfilePicture;
        }
