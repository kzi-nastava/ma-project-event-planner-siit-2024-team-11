...
public class SolutionDetails {
    ...
    public SolutionDetails(Long solutionId, SolutionType type, String name, String categoryName, String description, String specifics, Integer minReservationTime, Integer maxReservationTime, Integer reservationDeadline, Integer cancellationDeadline, ReservationConfirmationType reservationType, ArrayList<String> eventTypeNames, Double price, Integer discount, List<String> images, Boolean isVisible, Boolean isAvailable, Long providerId, String providerName, String providerImageUrl, Boolean isFavorite) {
